...
const BubbleIcon:React.FC<BubbleIconProps> = ({width, height}) => {
  ...
  <defs>
  <filter id="filter0_bf_8_41" x="-52" y="-52" width="437" height="437" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
  ...
  <filter id="filter1_f_8_41" x="141.6" y="46.6" width="145.8" height="145.8" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
  <feFlood floodOpacity="0" result="BackgroundImageFix"/>
